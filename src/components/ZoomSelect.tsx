...
export const ZoomSelect  = (props: any) => {
    const {setZoomState, selectCoords, setYAxisDomain, setXAxisDomain, setSelectCoords} = props;
    ...
    return (
        <svg onClick={(e: any) => {setZoomState(true)}} xmlns="http://www.w3.org/2000/svg" width="18" height="18" stroke="rgb(102, 102, 102)" viewBox="0 0 16 16">
